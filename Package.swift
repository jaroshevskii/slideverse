...
let package = Package(
  ...
  dependencies: [
    ...
    .package(
      url: "https://github.com/pointfreeco/swift-dependencies", .upToNextMinor(from: "1.17.0")),
    ...
    .package(url: "https://github.com/pointfreeco/sqlite-data", .upToNextMinor(from: "1.11.0")),
  ],
  targets: [
