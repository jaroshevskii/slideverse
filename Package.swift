...
let package = Package(
  ...
  dependencies: [
    ...
    .package(
      url: "https://github.com/pointfreeco/swift-dependencies", .upToNextMinor(from: "1.16.0")),
    ...
    .package(url: "https://github.com/pointfreeco/sqlite-data", .upToNextMinor(from: "1.10.0")),
  ],
  targets: [
